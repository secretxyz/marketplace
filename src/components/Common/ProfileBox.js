...
import { setAccount, setAuthToken, getSummaryAddress, notify } from '../Helpers/Utils';
...
const ProfileBox = ({ account }) => {
	...
	return (<div ref={innerRef} className="cs-toggle_box cs-profile_box">
			...
			<div className="cs-user_info">
				...
				<div className="cs-user_profile_link">
					<div className="cs-user_profile_link_in">
						...
						<button id="profile_wallet" onClick={onClickCopyWallet}>
						...
						<ReactTooltip anchorId="profile_wallet" className="cs-modal_tooltip" place="bottom" content="Copy wallet address" />
					</div>
				</div>
			</div>
			<ul>
				<li><a href="/my-profile/collected">My NFTs</a></li>
				<li><a href="/my-profile/offers">My Offers</a></li>
				<li><a href="/my-profile/activity">My Activity</a></li>
				<li><a href="/my-profile/favorites">My Favorites</a></li>
