...
const Header = () => {
	const { auth_token, wallet, slug, username, banner_picture_url, picture_url } = accountStore;
	// useEffect(() => {
	// 	mainNav();
	// }, []);
