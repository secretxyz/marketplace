                            ...
                            <div className="cs-main_header_right">
                                ...
                                <div className="cs-header_btns_wrap">
                                    <div className="cs-header_btns">
                                        ...
                                        <div className="cs-toggle_box cs-notification_box">
                                            <div className="cs-toggle_btn cs-header_icon_btn cs-center">
                                                <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <path d="M10.7981 16.3887C10.6663 16.616 10.477 16.8047 10.2493 16.9358C10.0216 17.067 9.76341 17.136 9.50063 17.136C9.23784 17.136 8.97967 17.067 8.75196 16.9358C8.52424 16.8047 8.33498 16.616 8.20312 16.3887" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
                                                </svg>
                                        ...
                                        <div className="cs-toggle_box cs-profile_box">
                                            <div className="cs-toggle_btn cs-header_icon_btn cs-center">
                                                <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.5 15.75V14.25C15.5 13.4544 15.1839 12.6913 14.6213 12.1287C14.0587 11.5661 13.2956 11.25 12.5 11.25H6.5C5.70435 11.25 4.94129 11.5661 4.37868 12.1287C3.81607 12.6913 3.5 13.4544 3.5 14.25V15.75" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
                                                    <path d="M9.5 8.25C11.1569 8.25 12.5 6.90685 12.5 5.25C12.5 3.59315 11.1569 2.25 9.5 2.25C7.84315 2.25 6.5 3.59315 6.5 5.25C6.5 6.90685 7.84315 8.25 9.5 8.25Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
                                                </svg>
                                            </div>
                                            <div className="cs-toggle_body">
                                                <div className="cs-user_info">
                                                    <h3 className="cs-user_name">David T</h3>
                                                    <h4 className="cs-user_balance">5890.00 XRP</h4>
                                                    <div className="cs-user_profile_link">
                                                        <div className="cs-user_profile_link_in">
                                                            <span>r1BAkZn7LrU43oK8Jv...</span>
                                                            <button>
                                                                <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a href="connect-wallet.html" className="cs-btn cs-style1"><span>Connect Wallet</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
