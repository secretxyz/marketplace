                ...
                <div className="cs-hero_in">
                    ...
                    <div className="cs-hero_in_right">
                        <div className="cs-raffle_banner_slider cs-style1 cs-gap-20">
                            <div className="cs-slider_container" data-autoplay="1" data-loop="0" data-speed="600" data-center="1" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="3" data-lg-slides="3" data-add-slides="3">
