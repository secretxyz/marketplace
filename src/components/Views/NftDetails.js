...
const NftDetails = (props) => {
    ...
    return (
        loading ? <PageLoader /> : <ContentWrapper>
                        ...
                        <div className="row">
                            <div className="col-xl-7">
                                <div className="cs-author_card cs-white_bg cs-box_shadow">
                                    <div className="cs-author_img"><img src={nft?.collection.picture_url} alt="" /></div>
                                    <div className="cs-author_right">
                                        <h3>{nft?.collection?.name}</h3>
                                        <p>created by {nft?.collection?.creator ? `@${nft?.collection?.creator.name}` : getSummaryAddress(nft?.collection?.issuer)}</p>
                                    </div>
                                </div>
                                <div className="cs-height_25 cs-height_lg_25"></div>
                            </div>
                            <div className="col-xl-5">
                                <div className="cs-author_card cs-white_bg cs-box_shadow">
                                    <div className="cs-author_img">
                                        <Avatar className="cs-profile_avatar_oval" {...{ name: nft?.owner?.wallet, image: nft?.owner?.picture_url }} />
                                    </div>
                                    <div className="cs-author_right">
                                        <h3>Owned by</h3>
                                        <p>{nft?.owner?.username ? `@${nft?.owner?.username}` : getSummaryAddress(nft?.owner?.wallet)}</p>
                                    </div>
                                </div>
                                <div className="cs-height_25 cs-height_lg_25"></div>
                            </div>
            ...
            <CreateRaffleModal nft={nft} refreshDetails={() => fetchNftDetails(tokenid)} />
        </ContentWrapper >
    );
}
