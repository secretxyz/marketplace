                    ...
                    <div className="row">
                        <div className="col-lg-8 offset-lg-2">
                            <div className="cs-single_post">
                                ...
                                <p> Instead of use of platform is not trustless. While most processes are automated and have been tested thoroughly, by using any of our tools you agree to accept any risk associated with entering raffles, trading on the marketplace, and hosting of raffles.</p>
